...
def tool_request_pc_shutdown() -> str:
    ...
    """
    # In the new architecture, this just returns a specific string flag
    # that the LLM pipeline intercepts to create a PendingAction.
...
ALL_TOOLS = [
    ...
    tool_lock_screen, tool_request_pc_shutdown
]
